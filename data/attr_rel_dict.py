...
join_types = ['right', 'left anti semi (not-in)', 'inner', 'semi', 'anti', 'left']

# parent_rel_types = ['inner', 'outer', 'subquery']
parent_rel_types = ['outer', 'inner']
...
#                'n_rk', 'r_rk']
index_names = ['idx_nation_regionkey', 'idx_customer_nationkey', 
               'idx_lineitem_part_supp', 'idx_supplier_nation_key']
